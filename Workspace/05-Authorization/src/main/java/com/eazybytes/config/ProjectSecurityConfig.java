	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.cors().configurationSource(new CorsConfigurationSource() {
			...
			public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
				...
				.antMatchers("/myAccount").hasRole("USER")	// in DB, the role name must be ROLE_USER
				.antMatchers("/myBalance").hasAnyRole("USER","ADMIN") // in DB, the role name must be ROLE_ADMIN
				.antMatchers("/myLoans").hasRole("ROOT") // in DB, the role name must be ROLE_ROOT
